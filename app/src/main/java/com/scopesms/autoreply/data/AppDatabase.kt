...
abstract class AppDatabase : RoomDatabase() {
     ...
     * Phase 8.
     *
     * Phase 8 briefly had its own `data/db/ScopeSmsDatabase.kt` — written in
     * parallel, before Phase 5b's branch was pushed and visible. It was deleted
     * in favour of this file rather than merged alongside it: two databases mean
     * two SQLite files and two connections, and no transaction could ever span a
     * queue job and its log row. This file was pushed first and its doc above
     * already reserved the slot, so Phase 8 yielded to it.
     *
